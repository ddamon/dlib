 ...
 * 
 */
public class NetBeanAdapter extends BeanAdapter<Object> implements INetAdapter {
	public List<FieldMap> fields;
	public DhNet dhnet;
	public int pageNo = 0;
	private int step = Consts.netadapter_step_default;
	...
	public String pageParams = Consts.netadapter_page_no;
	public String stepParams = Consts.netadapter_step;
	...
	public NetBeanAdapter(Class clazz, String url, Context context, int mResource) {
		super(context, mResource);
		dhnet = new DhNet(url);
		dhnet.setMethod(DhNet.METHOD_GET);
		fields = new ArrayList<FieldMap>();
		dialoger = IocContainer.getIocContainer().get(IDialog.class);
		mClazz = clazz;
		useCache();
	}
	...
	public void showNext() {
		...
		dhnet.addParam(Consts.netadapter_timeline, timeline);
	...
	public void showNextInDialog() {
		pageNo++;
		dhnet.addParam(Consts.netadapter_page_no, pageNo);
		dhnet.addParam(Consts.netadapter_step, step);
		dhnet.addParam(Consts.netadapter_timeline, timeline);
	...
	public String getTag() {
		...
		for (Iterator iterator = keys.iterator(); iterator.hasNext();) {
			...
			if (!string.equals(pageParams) && !string.equals(stepParams) && !string.equals(Consts.netadapter_timeline)) {
