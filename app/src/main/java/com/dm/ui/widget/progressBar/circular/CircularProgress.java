package com.dm.ui.widget.progressBar.circular;
...
public class CircularProgress extends View {
	...
	private static final Interpolator SWEEP_INTERPOLATOR = new AccelerateInterpolator();
	...
	public CircularProgress(Context context, AttributeSet attrs, int defStyle) {
		...
		TypedArray array = context.obtainStyledAttributes(attrs, new int[] {}, defStyle, 0);
		mBorderWidth = array.getDimension(R.styleable.CircularProgress_borderWidth, DEFAULT_BORDER_WIDTH * density);
		mColors = new int[4];
