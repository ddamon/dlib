package com.dm.ui.widget.linearlistview;
...
public class LinearListView extends IcsLinearLayout {
	...
	public LinearListView(Context context, AttributeSet attrs) {
		...
		final int dividerPaddingType = a.getInteger(LinearListView_dividerPaddingType, 0);
		if (dividerPaddingType != 0) {
			setDividerPaddingType(dividerPaddingType);
		}
	...
	public void setDividerPaddingType(int type) {
		if (getOrientation() == VERTICAL) {
			dividerPaddingType = type;
		} else {
			dividerPaddingType = type;
		}
		requestLayout();
