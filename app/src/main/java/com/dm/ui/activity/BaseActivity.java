...
public class BaseActivity extends Activity implements IBaseActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		wakeLock = new WakeLock(mContext, TAG);
	}
	...
	/**
	 * 
	 * @Description: 默认左进右出动画效果关闭activity-单独调用
	 * @return void
	 * @throw
	 */
	...
	public boolean isDAnimFinish() {
		return isDAnimFinish;
	}

	public void setDAnimFinish(boolean isDAnimFinish) {
		this.isDAnimFinish = isDAnimFinish;
	}
