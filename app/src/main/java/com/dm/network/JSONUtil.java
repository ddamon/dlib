...
public class JSONUtil {
	...
	/**
	 * @Description: 获取JsonObject中的String
	 * @param jo
	 * @param key
	 * @param def
	 * @return String
	...
	/**
	 * 
	 * @Description: 获取json数组中的第indexjson对象
	 * @param array
	 * @param index
	 * @return
	 * @return JSONObject
