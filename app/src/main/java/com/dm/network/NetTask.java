...
public abstract class NetTask {
	...
	static Handler handler = new Handler() {
		...
		public void handleMessage(Message msg) {
			...
			case TRANSFER_CODE: {
				try {
					GlobalCodeHandler golbal = IocContainer.getIocContainer().get(GlobalCodeHandler.class);
					if (golbal != null) {
	...
	public void OnCode(Response response) {
		// CodeHandler
		// codehandler=IocContainer.getShare().get(CodeHandler.class);
		// if(codehandler!=null){
		// if(mContext==null){
